    ...
    Modal.info({
      ...
      content: (
        <p>
          ...
          1. 상품을 스캔하세요.
          <br />
          2. [포장 완료 목록]에서 스캔된 상품의 Ai 인식결과를 참고하세요.
          <br />
          3. [권장 포장 옵션을 참고해 포장재를 선택하세요.
          <br />
          4. [Ai 인식결과]가 실물과 일치하고 이상이 없다면 포장 후 [정상 완료]를
          클릭해 다음 작업을 진행하세요.
          <br />
          5. [Ai 인식결과]가 실물과 맞지 않거나 상품 누락이 있다면 [누락보고]를
          클릭하세요. 해당 주문건은 나중에 작업할 수 있습니다. 상품이 보충될 수
          있도록 상자를 포장 구역 중앙에 가져다 주세요.
          <br />
          <br />
